...
if __name__ == '__main__':
    ...
    parser.add_argument('binary', default=None, help='Target binary (elf)', type=str)
    parser.add_argument(
        'func', default=None, help='Target function (must be void (*)(void), unless --setup is given)', type=str
    )
    parser.add_argument('--setup', default='', help='Target setup function (must be void (*)(void))', type=str)
    parser.add_argument('--out-dir', default=None, help='Path for output file (must be existing directory)', type=str)
